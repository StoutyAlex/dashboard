import React, { Component, PropTypes, ReactDOM, createRef } from 'react';
import Pie                             from './Pie';
...
class Gauge extends Component {
    componentDidMount() {
        ...
        this.gaugeRef = createRef();

        this.pie = new Pie(ReactDOM.findDOMNode(this.gaugeRef), {
            spacing,
            donutRatio,
            handAnchorRatio,
            handLengthRatio,
